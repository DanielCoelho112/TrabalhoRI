...
%   Desenha o referencial inicial
    ...
    fill3(Ref_0X(1:38), Ref_0Y(1:38), Ref_0Z(1:38), 'r', Ref_0X(39:end), Ref_0Y(39:end), Ref_0Z(39:end), 'b');
    hold on
...
%         fill3(Ref_X(1:38), Ref_Y(1:38), Ref_Z(1:38), color, Ref_X(39:end), Ref_Y(39:end), Ref_Z(39:end), color);
        fill3(Ref_X(1:38), Ref_Y(1:38), Ref_Z(1:38), color, Ref_X(39:end), Ref_Y(39:end), Ref_Z(39:end), 'b');
        hold on
    end
end